...
Get-FIMObject -Filter "/Approval[ApprovalStatus='Pending']/Requestor" -Attributes DisplayName,AccountName
...
Get-FIMObject -Filter "/Approval[ApprovalStatus='Pending']" -Attributes * | Where-Object EndPointAddress -like '*9ae686b3-0390-4e74-8372-5306fb06c2e0*' -OutVariable BadApprovals
