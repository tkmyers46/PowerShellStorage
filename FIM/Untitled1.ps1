...
Get-FIMObject -Filter "/Approval[ApprovalStatus='Pending']" -Attributes ObjectType, CreatedTime, Approver, Requestor,ApprovalStatus, EndPointAddress| Select-Object -Property *, `
