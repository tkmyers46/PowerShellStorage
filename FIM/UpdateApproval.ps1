...
param(
    ...
    [Parameter(Mandatory=$true, HelpMessage="Specify the value of the attribute to update.")]
    $attributeValue,
...
$objects = Export-FIMConfig -uri $uri -CustomConfig "/$fimtype[ApprovalStatus='Pending' and Requestor='b47de940-20a4-416f-8610-13993ab6577c']" -OnlyBaseResources
